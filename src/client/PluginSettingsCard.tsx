...
export function BooleanField(props: FieldProps & {
  ...
  return (
    <div className={css.field}>
      ...
      >
        <span className={checked ? css.switchTrackOn : css.switchTrack} aria-hidden="true">
          <span className={checked ? css.switchThumbOn : css.switchThumb} />
        </span>
        <span className={css.switchState}>{checked ? props.onLabel : props.offLabel}</span>
      </button>
