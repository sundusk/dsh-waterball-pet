window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var _dsh_css_waterball_module_css_default = {
			...
			"halo-questioning": "m0Tjba_halo-questioning",
