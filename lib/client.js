window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const tagId$1 = "@linxin666/dsh-moodball-web/waterball.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$1) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@linxin666/dsh-moodball-web";
		...
		*/
		...
		const tagId = "@linxin666/dsh-moodball-web/settings-card.module.css";
